...
@Entity
@Table(name = "jetty_head_type_formula")
public class JettyHeadTypeFormula {
	private long id;
	...
	public JettyHeadTypeFormula() {

	}

	public JettyHeadTypeFormula(long position, String name, long cap, String remarks, long qty, String satuan,
