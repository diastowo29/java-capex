...
@Entity
@Table(name = "jetty_4_formula")
public class Jetty4Formula {
	private long id;
	...
	public Jetty4Formula() {

	}

	public Jetty4Formula(long position, String name, long cap, String remarks, long qty, String satuan,
