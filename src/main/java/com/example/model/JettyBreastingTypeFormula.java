...
@Entity
@Table(name = "jetty_breasting_type_formula")
public class JettyBreastingTypeFormula {
	private long id;
	...
	public JettyBreastingTypeFormula() {

	}

	public JettyBreastingTypeFormula(long position, String name, long cap, String remarks, long qty, String satuan,
