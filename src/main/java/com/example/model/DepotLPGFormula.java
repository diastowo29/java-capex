...
@Entity
@Table(name = "depot_lpg_formula")
public class DepotLPGFormula {
	private long id;
	...
	public DepotLPGFormula() {

	}

	public DepotLPGFormula(long position, String name, long cap, String remarks, long qty, String satuan,
