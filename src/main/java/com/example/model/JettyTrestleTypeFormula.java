...
@Entity
@Table(name = "jetty_trestle_type_formula")
public class JettyTrestleTypeFormula {
	private long id;
	...
	public JettyTrestleTypeFormula() {

	}

	public JettyTrestleTypeFormula(long position, String name, long cap, String remarks, long qty, String satuan,
